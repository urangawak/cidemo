  ...
  <div class="tab-content">
    <div role="tabpanel" class="tab-pane active" id="cf_1">
    	...
    	<ul>
    		...
    		<li>Copy paste folder <b>select2 (pilih versi 4.0.1)</b> dari folder <b>assets</b> ke folder satu file index.php. Contoh folder <b>cdn/select2</b>.<br/>
    		Jadi strukturnya :<br/>
    		application<br/>
    		<b>cdn</b><br/>
    		<b>&nbsp;&nbsp; select2 (isi versi 4.0.1)</b><br/>
    		<b>&nbsp;&nbsp;&nbsp;&nbsp; isi versi 4.0.1</b><br/>
    		system<br/>
    		index.php<br/>
    		</li>
    	</ul>
