...
(function dFlip(DFLIP, $) {
	...
	var defaults = DFLIP.defaults = {
		...
		pdfjsSrc: dflip_path+"js/libs/pdf.min.js",
		//source link for PDF.WORKER.JS file
		pdfjsWorkerSrc: dflip_path+"js/libs/pdf.worker.min.js",

		//source link for THREE.JS file
		threejsSrc: dflip_path+"js/libs/three.min.js",
		//source link for MOCKUP.JS file
		mockupjsSrc: dflip_path+"js/libs/mockup.min.js",
		...
		soundFile: dflip_path+"sound/turn2.mp3",
